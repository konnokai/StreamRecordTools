...
FROM jun112561/dotnet_with_yt-dlp:2026.03.17 AS base
WORKDIR /app
...
CMD [ "sub", "--audo-delete", "-s", "-o", "/output", "-t", "/temp_path", "-u", "/youtube_unarchived", "--twitch-unarchived-output", "/twitch_unarchived", "-m", "/member_only_stream"]
